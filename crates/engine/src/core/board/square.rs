...
impl Square {
    ...
    ///
    /// ```
    /// use chess::{Square, Rank, File, Team};
    ///
    /// let mut sq = Square::make_square(Rank::Seventh, File::D);
    ///
    /// assert_eq!(sq.forward(Team::White).expect("Valid Square"), Square::make_square(Rank::Eighth, File::D));
    /// assert_eq!(sq.forward(Team::White).expect("Valid Square").forward(Team::White), None);
    ///
    /// sq = Square::make_square(Rank::Second, File::D);
    ///
    /// assert_eq!(sq.forward(Team::Black).expect("Valid Square"), Square::make_square(Rank::First, File::D));
    ...
    /// let mut sq = Square::make_square(Rank::Seventh, File::D);
    ///
    /// assert_eq!(sq.backward(Team::Black).expect("Valid Square"), Square::make_square(Rank::Eighth, File::D));
    /// assert_eq!(sq.backward(Team::Black).expect("Valid Square").backward(Team::Black), None);
    ///
    /// sq = Square::make_square(Rank::Second, File::D);
    ///
    /// assert_eq!(sq.backward(Team::White).expect("Valid Square"), Square::make_square(Rank::First, File::D));
    ...
    /// let mut sq = Square::make_square(Rank::Seventh, File::D);
    ///
    /// assert_eq!(sq.uforward(Team::White), Square::make_square(Rank::Eighth, File::D));
    /// assert_eq!(sq.uforward(Team::White).uforward(Team::White), Square::make_square(Rank::First, File::D));
    ///
    /// sq = Square::make_square(Rank::Second, File::D);
    ///
    /// assert_eq!(sq.uforward(Team::Black), Square::make_square(Rank::First, File::D));
    /// assert_eq!(sq.uforward(Team::Black).uforward(Team::Black), Square::make_square(Rank::Eighth, File::D));
    /// ```
    #[inline]
    ...
    /// let mut sq = Square::make_square(Rank::Seventh, File::D);
    ///
    /// assert_eq!(sq.ubackward(Team::Black), Square::make_square(Rank::Eighth, File::D));
    /// assert_eq!(sq.ubackward(Team::Black).ubackward(Team::Black), Square::make_square(Rank::First, File::D));
    ///
    /// sq = Square::make_square(Rank::Second, File::D);
    ///
    /// assert_eq!(sq.ubackward(Team::White), Square::make_square(Rank::First, File::D));
    /// assert_eq!(sq.ubackward(Team::White).ubackward(Team::White), Square::make_square(Rank::Eighth, File::D));
    /// ```
    #[inline]
